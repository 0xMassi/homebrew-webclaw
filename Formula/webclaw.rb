class Webclaw < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/0xMassi/webclaw/releases/download/v0.1.1/webclaw-v0.1.1-aarch64-apple-darwin.tar.gz"
      sha256 "c16f8bd49e8a9fade1a101610d79fffff6546d05f1781660de88217ec3e5136e"
    else
