class Webclaw < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/0xMassi/webclaw/releases/download/v0.2.1/webclaw-v0.2.1-aarch64-apple-darwin.tar.gz"
      sha256 "c4c3b5502a5a65b772fa1bd24e9dc32be6e490893d1dc645e9da5cd71627a51b"
    else
