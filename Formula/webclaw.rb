class Webclaw < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/0xMassi/webclaw/releases/download/v0.3.1/webclaw-v0.3.1-aarch64-apple-darwin.tar.gz"
      sha256 "25ea16427ef1b104d6a2b40684185d9d7fcc79ef3e3578e019272483664d7fc9"
    else
