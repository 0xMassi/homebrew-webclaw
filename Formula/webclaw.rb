class Webclaw < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/0xMassi/webclaw/releases/download/v0.2.2/webclaw-v0.2.2-aarch64-apple-darwin.tar.gz"
      sha256 "b2fa7c7f63c8eb36ae2cf75693dcd30f187ba56ded9ec1472c1cf7cd923aa60f"
    else
