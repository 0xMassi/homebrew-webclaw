class Webclaw < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/0xMassi/webclaw/releases/download/v0.1.6/webclaw-v0.1.6-aarch64-apple-darwin.tar.gz"
      sha256 "bc569742ab6e5123bb8c09fcd9ae51647ef6c99df70e38d0792a5657f7e1977d"
    else
