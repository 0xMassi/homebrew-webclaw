class Webclaw < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/0xMassi/webclaw/releases/download/v0.1.2/webclaw-v0.1.2-aarch64-apple-darwin.tar.gz"
      sha256 "0414727f6b6e8e0bcfcf1400beb4c3106c7459b47d257aac577c95021601bb6f"
    else
