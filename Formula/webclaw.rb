class Webclaw < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/0xMassi/webclaw/releases/download/v0.1.4/webclaw-v0.1.4-aarch64-apple-darwin.tar.gz"
      sha256 "ab435e770950567bd11d9ddef2ea4a40519bd08cdc21b88e5ef3bbbd520c7117"
    else
