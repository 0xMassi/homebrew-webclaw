class Webclaw < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/0xMassi/webclaw/releases/download/v0.1.5/webclaw-v0.1.5-aarch64-apple-darwin.tar.gz"
      sha256 "6921c8bfbfeaec890ba1f14e1b2ef7a81e2d7b5b4347bbdd6632a54e1643117a"
    else
